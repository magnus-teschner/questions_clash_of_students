document.addEventListener('DOMContentLoaded', () => {
    ...
    async function openModal(row) {
        ...
        console.log(program, course, lection);
        ...
        document.getElementById('edit-program').textContent = program;
        document.getElementById('edit-course').textContent = course;
        document.getElementById('edit-lection').textContent = lection;
        document.getElementById('edit-position').textContent = position;
