...
send_button.addEventListener('click', (event) => {
  ...
  function create_question_json_multiple(type, correct_answer) {
    ...
    let question = {
      ...
      question_type: type,
      answer_a: inputA.value,
      answer_b: inputB.value,
      answer_c: inputC.value,
      answer_d: inputD.value,
      correct_answer: correct_answer,
      position: position.getAttribute('data-position'),
      lection_id: lection.getAttribute('data-lection-id')
    }
    return question
  }
